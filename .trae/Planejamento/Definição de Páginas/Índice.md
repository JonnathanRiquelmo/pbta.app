...
- Segue as rotas definidas em `.trae/Planejamento/Rotas.md`.
- Aplicar o Design System em todos os componentes.
- Considerar estados offline e eventos de Analytics conforme `.trae/Planejamento/Implementação PWA e Offline.md` e `.trae/Planejamento/Monitoramento e Analytics.md`.
