...
**Referências**
- `.trae/Planejamento/Configuração Firebase.md:18-47` (config básica)
- `.trae/Planejamento/Configuração Firebase.md:49-63` (persistência offline)
- `.trae/Planejamento/DOCUMENTO DE REQUISITOS - pbta.app  .md:31-40` (config obrigatória)
- `.trae/Planejamento/DOCUMENTO DE REQUISITOS - pbta.app  .md:56-65` (regras de segurança)
